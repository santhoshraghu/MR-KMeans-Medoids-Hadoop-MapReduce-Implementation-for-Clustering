...
public class KMeans_Iris_5ii {
    ...
    public static class KMeansMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new IntWritable(nearestCenter.id), new Text(point.getX() + ":" + point.getY() + ":" + point.getZ() + ":" + point.getW()));
        }
    ...
    public static class KMeansReducer extends Reducer<IntWritable, Text, IntWritable, Text> {
        ...
        public void reduce(IntWritable key, Iterable<Text> values, Context context) throws IOException, InterruptedException {
            ...
            context.write(new IntWritable(key.get()), new Text("C:" + newCenter.point.getX() + "," + newCenter.point.getY() + "," + newCenter.point.getZ() + "," + newCenter.point.getW()));

            // Emit the data points associated with this cluster center
            for (Point point : points) {
                context.write(new IntWritable(key.get()), new Text("D:" + point.getX() + "," + point.getY() + "," + point.getZ() + "," + point.getW()));
            }
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputPath = "C://Users//user//Downloads//Output_Task_4f_k3";
        ...
        job.setJarByClass(KMeans_Iris_5ii.class);

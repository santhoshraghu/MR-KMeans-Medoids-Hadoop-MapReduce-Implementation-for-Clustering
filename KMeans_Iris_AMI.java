...
public class KMeans_Iris_AMI {
    ...
    // Define your early convergence threshold (e.g., the minimum change in centroids)
    ...
    public static class KMeansMapper extends Mapper<LongWritable, Text, IntWritable, Text> {
        ...
        public void map(LongWritable key, Text value, Context context) throws IOException, InterruptedException {
            ...
            context.write(new IntWritable(nearestCenter.id), new Text(x + ":" + y + ":" + z + ":" + w));
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputPath = "C://Users//user//Downloads//Output_Task_4c_k7";
        ...
        job.setJarByClass(KMeans_Iris_AMI.class);
        ...
        for (int iteration = 1; iteration <= maxIterations; iteration++) {
            ...
            if (iteration < maxIterations) {
                ...
                // Check for convergence using the early convergence threshold

...
public class KMeans_Iris_5i {
    ...
    public static class KMeansReducer extends Reducer<IntWritable, Point, IntWritable, Text> {
        ...
        public void reduce(IntWritable key, Iterable<Point> values, Context context) throws IOException, InterruptedException {
            ...
            ClusterCenter newCenter = computeNewCenter(points);
            context.write(key, new Text(newCenter.point.getX() + "," + newCenter.point.getY() + "," + newCenter.point.getZ() + "," + newCenter.point.getW()));
        }
    ...
    public static void main(String[] args) throws Exception {
        ...
        outputPath = "C://Users//user//Downloads//Output_Task_4e_k3";
        ...
        job.setJarByClass(KMeans_Iris_5i.class);
        job.setMapperClass(KMeans_Iris_5i.KMeansMapper.class);
        job.setCombinerClass(KMeansCombiner.class);
        job.setReducerClass(KMeans_Iris_5i.KMeansReducer.class);
        ...
        if (converged) {
            ...
            try (FSDataOutputStream out = fs.create(clusterCenterOutputPath)) {
                ...
                for (ClusterCenter center : centroids) {
                    String outputLine = center.point.getX() + "," + center.point.getY() + "," + center.point.getZ() + "," + center.point.getW() + "\n";
